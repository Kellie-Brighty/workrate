...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const employerMenuItems = [
    ...
    },
    {
      ...
      active: location.pathname === "/employer/employees",
    },
    {
      name: "Projects",
      icon: (
      ...
      active:
        location.pathname === "/employer/projects" ||
        location.pathname.startsWith("/employer/projects/"),
    },
    {
      name: "Tasks",
      icon: (
      ...
      href: "/employer/tasks",
      active: location.pathname === "/employer/tasks",
    },
    {
      name: "Time Approvals",
      icon: (
      ...
      href: "/employer/timeapprovals",
      active: location.pathname === "/employer/timeapprovals",
    },
    {
      name: "Analytics",
      icon: (
      ...
      active: location.pathname === "/employer/analytics",
    },
    {
      name: "Rewards",
      icon: (
      ...
      href: "/employer/rewards",
      active: location.pathname === "/employer/rewards",
    },
    {
      name: "Tickets",
      icon: (
      ...
      active: location.pathname === "/employer/tickets",
    },
    {
      name: "Settings",
      icon: (
      ...
      active: location.pathname === "/employer/settings",
    },
  ];
  ...
  const employeeMenuItems = [
    ...
    },
    {
      ...
      active: location.pathname === "/employee/performance",
    },
    {
      name: "My Rewards",
      icon: (
      ...
      active: location.pathname === "/employee/rewards",
    },
    {
      name: "Tickets",
      icon: (
      ...
      active: location.pathname === "/employee/tickets",
    },
    {
      name: "Profile",
      icon: (
  ...
  const menuItems =
    userType === "employer" ? employerMenuItems : employeeMenuItems;

  return (
    <div
      className={`${
        expanded ? "w-64" : "w-20"
      } bg-indigo-800 text-white h-full transition-all duration-300 ease-in-out overflow-hidden`}
    >
      <button
        className="absolute -right-3 top-20 bg-indigo-500 rounded-full p-1 shadow-lg hidden md:block"
        onClick={() => setExpanded(!expanded)}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className={`h-5 w-5 text-white transform transition-transform ${
            expanded ? "rotate-180" : ""
          }`}
          fill="none"
          viewBox="0 0 24 24"
      ...
      <div className="p-6 flex items-center">
        ...
        {expanded && <h1 className="ml-3 text-2xl font-bold">Workrate</h1>}
      </div>
